...
Kadira._pingToCheckAuth = function (callback) {                                                                       // 129
  var httpOptions = {headers: Kadira.options.authHeaders, data: {}};                                                  // 130
  var endpoint = Kadira.options.endpoint + '/ping';                                                                   // 131
  var authRetry = new Retry({                                                                                         // 132
    minCount: 0, // don't do any immediate retries                                                                    // 133
    baseTimeout: 5 * 1000                                                                                             // 134
  });                                                                                                                 // 135
                                                                                                                      // 136
  Kadira._postData(endpoint, httpOptions, function(err, response){                                                    // 137
    if(response) {                                                                                                    // 138
      if(response.statusCode == 200) {                                                                                // 139
        console.log('Kadira: successfully authenticated');                                                            // 140
        authRetry.clear();                                                                                            // 141
        callback();                                                                                                   // 142
      } else if(response.statusCode == 401) {                                                                         // 143
        console.error('Kadira: authentication failed - check your appId & appSecret')                                 // 144
      } else {                                                                                                        // 145
        retryPingToCheckAuth({message: "unidentified error code: " + response.statusCode});                           // 146
      }                                                                                                               // 147
    } else {                                                                                                          // 148
      retryPingToCheckAuth(err);                                                                                      // 149
    }                                                                                                                 // 150
  });                                                                                                                 // 151
                                                                                                                      // 152
  function retryPingToCheckAuth(err){                                                                                 // 153
    console.log('Kadira: retrying to authenticate (error: %s)', err.message);                                         // 154
    authRetry.retryLater(Kadira.authCheckFailures, function(){                                                        // 155
      Kadira._pingToCheckAuth(callback);                                                                              // 156
    });                                                                                                               // 157
  }                                                                                                                   // 158
}                                                                                                                     // 159
                                                                                                                      // 160
Kadira._sendAppStats = function () {                                                                                  // 161
  var appStats = {};                                                                                                  // 162
  appStats.release = Meteor.release;                                                                                  // 163
  appStats.protocolVersion = '1.0.0';                                                                                 // 164
  appStats.packageVersions = [];                                                                                      // 165
  appStats.appVersions = {                                                                                            // 166
    webapp: __meteor_runtime_config__['autoupdateVersion'],                                                           // 167
    refreshable: __meteor_runtime_config__['autoupdateVersionRefreshable'],                                           // 168
    cordova: __meteor_runtime_config__['autoupdateVersionCordova']                                                    // 169
  }                                                                                                                   // 170
                                                                                                                      // 171
  // TODO get version number for installed packages                                                                   // 172
  _.each(Package, function (v, name) {                                                                                // 173
    appStats.packageVersions.push({name: name, version: null});                                                       // 174
  });                                                                                                                 // 175
                                                                                                                      // 176
  Kadira._send({                                                                                                      // 177
    host: Kadira.options.hostname,                                                                                    // 178
    startTime: new Date(),                                                                                            // 179
    appStats: appStats                                                                                                // 180
  });                                                                                                                 // 181
}                                                                                                                     // 182
                                                                                                                      // 183
Kadira._schedulePayloadSend = function () {                                                                           // 184
  setTimeout(function () {                                                                                            // 185
    Kadira._sendPayload(Kadira._schedulePayloadSend);                                                                 // 186
  }, Kadira.options.payloadTimeout);                                                                                  // 187
}                                                                                                                     // 188
                                                                                                                      // 189
Kadira._sendPayload = function (callback) {                                                                           // 190
  new Fibers(function() {                                                                                             // 191
    var payload = Kadira._buildPayload();                                                                             // 192
    Kadira._send(payload, function (err) {                                                                            // 193
      if(err) {                                                                                                       // 194
        console.error('Kadira: Error sending payload (dropped after 5 tries)', err.message);                          // 195
      }                                                                                                               // 196
                                                                                                                      // 197
      callback && callback();                                                                                         // 198
                                                                                                                      ...
                                                                                                                      // 202
Kadira._send = function (payload, callback) {                                                                         // 203
  var endpoint = Kadira.options.endpoint;                                                                             // 204
  var httpOptions = {headers: Kadira.options.authHeaders, data: payload};                                             // 205
  var payloadRetries = 0;                                                                                             // 206
  var payloadRetry = new Retry({                                                                                      // 207
    minCount: 0, // don't do any immediate payloadRetries                                                             // 208
    baseTimeout: 5*1000,                                                                                              // 209
    maxTimeout: 60000                                                                                                 // 210
  });                                                                                                                 // 211
                                                                                                                      // 212
  callHTTP();                                                                                                         // 213
                                                                                                                      // 214
  function callHTTP() {                                                                                               // 215
    Kadira._postData(endpoint, httpOptions, function(err, response){                                                  // 216
      if(!(response && response.statusCode)) {                                                                        // 217
        err = err || new Error("Kadira: Unknown Error");                                                              // 218
        return tryAgain(err);                                                                                         // 219
      }                                                                                                               // 220
                                                                                                                      // 221
      var status = response.statusCode;                                                                               // 222
                                                                                                                      // 223
      if(status === 200) {                                                                                            // 224
        if(payloadRetries > 0) {                                                                                      // 225
          logger('connected again and payload sent.')                                                                 // 226
        }                                                                                                             // 227
                                                                                                                      // 228
        cleaPayloadRetry();                                                                                           // 229
        return callback && callback();                                                                                // 230
      }                                                                                                               // 231
                                                                                                                      // 232
      // do not retry if authentication fails                                                                         // 233
      if(status === 401) {                                                                                            // 234
        throw new Error('Kadira: AppId, AppSecret combination is invalid');                                           // 235
      }                                                                                                               // 236
                                                                                                                      // 237
      if(status < 400 || status > 600) {                                                                              // 238
        err = err || new Error("Kadira: error: " + status);                                                           // 239
        return tryAgain(err);                                                                                         // 240
      }                                                                                                               // 241
                                                                                                                      // 242
      if(status >= 500 && status < 600) {                                                                             // 243
        if(!err) {                                                                                                    // 244
          err = new Error("Kadira: server error: " + status);                                                         // 245
        }                                                                                                             // 246
                                                                                                                      // 247
        return tryAgain(err);                                                                                         // 248
      }                                                                                                               // 249
                                                                                                                      // 250
      // do not retry for kadira agent errors                                                                         // 251
      if(status >= 400 && status < 500) {                                                                             // 252
        console.error('Kadira: agent error:', status);                                                                // 253
      }                                                                                                               // 254
                                                                                                                      // 255
      cleaPayloadRetry();                                                                                             // 256
      callback && callback();                                                                                         // 257
    });                                                                                                               // 258
  }                                                                                                                   // 259
                                                                                                                      // 260
  function tryAgain(err) {                                                                                            // 261
    err = err || {};                                                                                                  // 262
    logger('retrying to send payload to server')                                                                      // 263
    if(++payloadRetries < 5) {                                                                                        // 264
      payloadRetry.retryLater(payloadRetries, callHTTP);                                                              // 265
    } else {                                                                                                          // 266
      cleaPayloadRetry();                                                                                             // 267
      callback && callback(err);                                                                                      // 268
    }                                                                                                                 // 269
  }                                                                                                                   // 270
                                                                                                                      // 271
  function cleaPayloadRetry() {                                                                                       // 272
    payloadRetries = 0;                                                                                               // 273
    payloadRetry.clear();                                                                                             // 274
  }                                                                                                                   // 275
}                                                                                                                     // 276
                                                                                                                      // 277
// this return the __kadiraInfo from the current Fiber by default                                                     // 278
// if called with 2nd argument as true, it will get the kadira info from                                              // 279
// Meteor.EnvironmentVariable                                                                                         // 280
//                                                                                                                    // 281
// WARNNING: returned info object is the reference object.                                                            // 282
//  Changing it might cause issues when building traces. So use with care                                             // 283
Kadira._getInfo = function(currentFiber, useEnvironmentVariable) {                                                    // 284
  currentFiber = currentFiber || Fibers.current;                                                                      // 285
  if(currentFiber) {                                                                                                  // 286
    if(useEnvironmentVariable) {                                                                                      // 287
      return Kadira.env.kadiraInfo.get();                                                                             // 288
    }                                                                                                                 // 289
    return currentFiber.__kadiraInfo;                                                                                 // 290
  }                                                                                                                   // 291
};                                                                                                                    // 292
                                                                                                                      // 293
// this does not clone the info object. So, use with care                                                             // 294
Kadira._setInfo = function(info) {                                                                                    // 295
  Fibers.current.__kadiraInfo = info;                                                                                 // 296
};                                                                                                                    // 297
                                                                                                                      // 298
Kadira.enableErrorTracking = function () {                                                                            // 299
  __meteor_runtime_config__.kadira.enableErrorTracking = true;                                                        // 300
  Kadira.options.enableErrorTracking = true;                                                                          // 301
};                                                                                                                    // 302
                                                                                                                      // 303
Kadira.disableErrorTracking = function () {                                                                           // 304
  __meteor_runtime_config__.kadira.enableErrorTracking = false;                                                       // 305
  Kadira.options.enableErrorTracking = false;                                                                         // 306
};                                                                                                                    // 307
                                                                                                                      // 308
Kadira.trackError = function (type, message, options) {                                                               // 309
  if(Kadira.options.enableErrorTracking && type && message) {                                                         // 310
    options = options || {};                                                                                          // 311
    options.subType = options.subType || 'server';                                                                    // 312
    options.stacks = options.stacks || '';                                                                            // 313
    var error = {message: message, stack: options.stacks};                                                            // 314
    var trace = {                                                                                                     // 315
      type: type,                                                                                                     // 316
      subType: options.subType,                                                                                       // 317
      name: message,                                                                                                  // 318
      errored: true,                                                                                                  // 319
      at: Kadira.syncedDate.getTime(),                                                                                // 320
      events: [['start', 0, {}], ['error', 0, {error: error}]],                                                       // 321
      metrics: {total: 0}                                                                                             // 322
    };                                                                                                                // 323
    Kadira.models.error.trackError(error, trace);                                                                     // 324
  }                                                                                                                   // 325
}                                                                                                                     // 326
                                                                                                                      // 327
Kadira.ignoreErrorTracking = function (err) {                                                                         // 328
  err._skipKadira = true;                                                                                             // 329
}                                                                                                                     // 330
                                                                                                                      // 331
Kadira._postData = function (endpoint, options, callback) {                                                           // 332
  var content = JSON.stringify(options.data);                                                                         // 333
                                                                                                                      // 334
  var headers = options.headers;                                                                                      // 335
  headers['Content-Type'] = 'application/json';                                                                       // 336
                                                                                                                      // 337
  var options = {                                                                                                     // 338
    url: endpoint,                                                                                                    // 339
    method: 'POST',                                                                                                   // 340
    ...
    headers: headers                                                                                                  // 343
                                                                                                                      ...
                                                                                                                      // 345
  if(Kadira.options.proxy) {                                                                                          // 346
    options.proxy = Kadira.options.proxy;                                                                             // 347
  }                                                                                                                   // 348
                                                                                                                      // 349
  request(options, function (error, res, body) {                                                                      // 350
    if(error) {                                                                                                       // 351
      console.error('Kadira:', error.message);                                                                        // 352
      return callback(error);                                                                                         // 353
    }                                                                                                                 // 354
                                                                                                                      // 355
    var response = {};                                                                                                // 356
    response.statusCode = res.statusCode;                                                                             // 357
    callback(null, response);                                                                                         // 358
  });                                                                                                                 // 359
}                                                                                                                     // 360
                                                                                                                      // 361
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
